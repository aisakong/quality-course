    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="app-navbar-collapse">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="{{ active_class(if_route('series.index')) }}"><a href="{{ route('series.index') }}">课程</a></li>
                <li class="{{ active_class((if_route('topics.index') || if_route('category.show'))) }}"><a href="{{ route('topics.index') }}">话题</a></li>
                <li><a href="">资源</a></li>
